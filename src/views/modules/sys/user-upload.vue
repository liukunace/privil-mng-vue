<template>
  <div class="filebox">
    ...
    <!-- <input type="button" value='Select UserFile' class='selectbutton'> -->
    <!-- <el-button type="info" class="selectbutton" round>用户文件</el-button> -->
...
export default {
  ...
  methods: {
    ...
    download() {
      let url = this.$httpk.adornUrl("/exc/exp"),
        options = {};
      return new Promise((resolve, reject) => {
        ...
        this.$ajax({
          ...
          (response) => {
            ...
            //console.log(blob);
            let fileName = "用户模板"+Date.parse(new Date()) + ".xlsx";
